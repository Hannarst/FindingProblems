# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-17 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(null=True, to='problems.Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complexity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='complexity', to='problems.Category')),
                ('language', models.ManyToManyField(null=True, related_name='language', to='problems.Category')),
